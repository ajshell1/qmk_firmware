...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT_h7v3_183(
        ...
        KC_F5,   KC_F6,    KC_EXLM,  KC_UNDO, KC_PASTE, KC_CUT ,  KC_TAB ,  KC_Q,     KC_W,     KC_E,     KC_R,     KC_T,    KC_LBRACKET,      KC_Y,     KC_U,    KC_I,     KC_O,    KC_P,    KC_QUOT, KC_BSPC, KC_CLEAR, KC_HOME,                                                          KC_P7,     KC_P8,    KC_P9,    KC_PMNS, //26
        KC_F7,   KC_F8,    KC_SELECT,H_DEBUG, MO(_FN), MO(_APL),  KC_LCTRL,   KC_A,     KC_S,     KC_D,     KC_F,     KC_G,   KC_RBRACKET,  KC_H,     KC_J,    KC_K,     KC_L, KC_SCOLON,    KC_ENT, H_LINE, H_PAGE,                                                                        KC_P4,     KC_P5,    KC_P6,    KC_PPLS, //25
        KC_F9,   KC_F10,   H_TTY,    KC_LOCK, KC_HOME,  KC_END ,  MO(_GREEK), KC_LSFT,  KC_Z,     KC_X,     KC_C,     KC_V,    KC_B,    KC_SLASH,  KC_N,    KC_M,     KC_COMM, KC_DOT,    KC_RSFT, MO(_GREEK),KC_UP,    KC_END,                                                             KC_P1,     KC_P2,    KC_P3,    KC_ENTER,//26
