...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT_h7v3_183(
        ...
        KC_F3,   KC_F4,    KC_FIND,  H_WRITE, KC_LEAD,  H_DOUBLE_QUOTE__PLUS_MINUS, KC_GESC,  KC_1,     KC_2,     KC_3,     KC_4,     KC_5,    KC_6,     KC_BSLASH,     KC_7,    KC_8,     KC_9,    KC_0,     KC_MINS,  KC_EQL,   H_L_BRACE__L_CHEVRON,  H_R_BRACE__R_CHEVRON,  KC_UNDO,    KC_TILD,   KC_SLSH,  KC_PAST,  KC_PMNS, //27
        ...
        KC_F7,   KC_F8,    KC_SELECT,H_DEBUG, MO(_FN), KC_NO,       MO(_APL), KC_A,     KC_S,     KC_D,     KC_F,     KC_G,   KC_RBRACKET,  KC_H,     KC_J,    KC_K,     KC_L, KC_SCOLON,    KC_ENT, H_LINE, H_PAGE,                                                           KC_P4,     KC_P5,    KC_P6,    KC_AMPR, //25
