...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT_h7v3_183(
        ...
        KC_F9,   KC_F10,   H_TTY,    KC_LOCK, KC_HOME,  KC_END ,  MO(_GREEK), KC_LSFT,  KC_X,     KC_C,     KC_D,     KC_V,    KC_Z,    KC_SLASH,  KC_K,    KC_H,     KC_COMM, KC_DOT,    KC_RSFT, MO(_GREEK),KC_UP,    KC_END,                                                             KC_P1,     KC_P2,    KC_P3,    KC_ENTER,//26
