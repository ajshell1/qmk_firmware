...
// Unicode char definitions
    ...
    [FTS_BOX_VS] = 0x2502,
    [FTS_BOX_HS] = 0x2500,
    [FTS_BOX_DS_RS] = 0x250C,
    [FTS_BOX_DS_HS] = 0x252C,
    [FTS_BOX_DS_LS] = 0x2510,
    [FTS_BOX_VS_RS] = 0x251C,
    [FTS_BOX_VS_HS] = 0x253C,
    [FTS_BOX_VS_LS] = 0x2524,
    [FTS_BOX_US_RS] = 0x2514,
    [FTS_BOX_US_HS] = 0x2534,
    [FTS_BOX_US_LS] = 0x2518,
    [FTS_BOX_VD] = 0x2551,
    [FTS_BOX_HD] = 0x2550,
    [FTS_BOX_DD_RD] = 0x2554,
    [FTS_BOX_DD_HD] = 0x2566,
    [FTS_BOX_DD_LD] = 0x2557,
    [FTS_BOX_VD_RD] = 0x2560,
    [FTS_BOX_VD_HD] = 0x256C,
    [FTS_BOX_VD_LD] = 0x2563,
    [FTS_BOX_UD_RD] = 0x255A,
    [FTS_BOX_UD_HD] = 0x2569,
    [FTS_BOX_UD_LD] = 0x255D,
    [FTS_BOX_DD_RS] = 0x2553,
    [FTS_BOX_DD_HS] = 0x2565,
    [FTS_BOX_DD_LS] = 0x2556,
    [FTS_BOX_VD_RS] = 0x255F,
    [FTS_BOX_VD_HS] = 0x256B,
    [FTS_BOX_VD_LS] = 0x2562,
    [FTS_BOX_UD_RS] = 0x2559,
    [FTS_BOX_UD_HS] = 0x2568,
    [FTS_BOX_UD_LS] = 0x255C,
    [FTS_BOX_DS_RD] = 0x2552,
    [FTS_BOX_DS_HD] = 0x2564,
    [FTS_BOX_DS_LD] = 0x2555,
    [FTS_BOX_VS_RD] = 0x255E,
    [FTS_BOX_VS_HD] = 0x256A,
    [FTS_BOX_VS_LD] = 0x2561,
    [FTS_BOX_US_RD] = 0x2558,
    [FTS_BOX_US_HD] = 0x2567,
    [FTS_BOX_US_LD] = 0x255B,
...
*└─────┴─────┴─────┴─────┘  └─────┴─────┴─────┴─────┴────────┴─────┴────────┴────────┴─────┴────────┴────────┴─────┴────────┴─────┴─────┴─────┴─────┘ └─────┴─────┴─────┴─────┘
    ...
    [_BASE] = LAYOUT_h7v3_183(
		...
		KC_F15,     KC_F16,     KC_F3,      KC_F4,          KC_PAUSE,         X(PLUS_MINUS),  KC_GRAVE,   KC_1,       KC_2,       KC_3,       KC_4,       KC_5,       KC_6,       KC_BSLS,    KC_7,       KC_8,       KC_9,       KC_0,       KC_MINUS,   KC_EQUAL,   KC_DEL,     KC_CAPS,      KC_PGUP,            KC_NLCK,    KC_PSLS,    KC_PAST,    KC_EQL,
	    ...
	    KC_F19,     KC_F20,     KC_F7,      KC_F8,          MO(_FN),          MO(_APL),        LCTL_T(KC_ESC),    KC_A,       KC_R,       KC_S,       KC_T,       KC_D,       KC_RBRC,    KC_H,       KC_N,       KC_E,       KC_I,       KC_O,       KC_ENTER,          MO(_CYR),              KC_PGDN,        KC_P4,      KC_P5,      KC_P6,      KC_PPLS,
    ...
    [_APL] = LAYOUT_h7v3_183(
        ...
        X(FTS_BOX_DD_RD),X(FTS_BOX_DD_HD),X(FTS_BOX_DD_LD),FT,       FT,       FT,       FT,  X(N_ARY_LOGICAL_AND), X(N_ARY_LOGICAL_OR), X(N_ARY_INTERSECT), X(N_ARY_UNION), X(SUBSET_OF),FT,X(SUPERSET_OF), X(FORALL),X(LEMNISCATE), X(THERE_EXISTS),FT,       FT,      FT,      FT,       FT,                                        X(FTS_BOX_DS_RS),X(FTS_BOX_DS_HS),X(FTS_BOX_DS_LS),FT,
        X(FTS_BOX_VD_RD),X(FTS_BOX_VD_HD),X(FTS_BOX_VD_LD),FT,       FT,       FT,       FT,  X(UP_TACK), X(DOWN_TACK), X(RIGHT_TACK), X(LEFT_TACK), X(UPWARDS_ARROW),FT,X(DOWNARDS_ARROW), X(LEFTWARDS_ARROW),X(RIGHTWARDS_ARROW), X(LEFTRIGHT_ARROW),X(PARTIAL_DIFFERENTIAL),       FT,      FT,      FT,                            X(FTS_BOX_VS_RS),X(FTS_BOX_VS_HS),X(FTS_BOX_VS_LS),FT,
        X(FTS_BOX_UD_RD),X(FTS_BOX_UD_HD),X(FTS_BOX_UD_LD),FT,       FT,       FT,       FT,       FT,  X(LEFT_FLOOR), X(LEFT_CEILING), X(NOT_EQUAL_TO), X(ASYMPTOTICALLY_EQUAL_TO),X(NOT_ASYMPTOTICALLY_EQUAL_TO),FT, X(LESS_THAN_OR_EQUAL),X(GREATER_THAN_OR_EQUAL),      FT,       FT,       FT,      FT,      FT,       FT,        X(FTS_BOX_US_RS),X(FTS_BOX_US_HS),X(FTS_BOX_US_LS),FT,
        X(FTS_BOX_VD),FT,X(FTS_BOX_HD),FT,       FT,       FT,       FT,       FT,       FT,       FT,       FT,       FT,      FT,       FT,      FT,       FT,      FT,       FT,       FT,      FT,      FT,                                                                                                    X(FTS_BOX_VS),FT,X(FTS_BOX_HS),FT
    ),
...
*│     │     │     │     │  │     │     │     │     │        │     │        │        │     │        │        │     │        │     │     │     │     │ │     │     │     │     │
*└─────┴─────┴─────┴─────┘  └─────┴─────┴─────┴─────┴────────┴─────┴────────┴────────┴─────┴────────┴────────┴─────┴────────┴─────┴─────┴─────┴─────┘ └─────┴─────┴─────┴─────┘
*Greek on the mainboard is  filled with what the space cadet historically had.
     */
    [_GREEK] = LAYOUT_h7v3_183(
        ...
        X(FTS_BOX_DD_RS),X(FTS_BOX_DD_HS),X(FTS_BOX_DD_LS),       FT,       FT,       FT,       FT,  XP(GREEK_LC_XI, GREEK_UC_XI), X(GREEK_LC_FINAL_SIGMA), XP(GREEK_LC_PHI, GREEK_UC_PHI), XP(GREEK_LC_PI, GREEK_UC_PI), XP(GREEK_LC_GAMMA, GREEK_UC_GAMMA), X(MATHEMATICAL_LEFT_WHITE_SQUARE_BRACKET), XP(GREEK_LC_YOT, GREEK_UC_YOT),XP(GREEK_LC_LAMDA, GREEK_UC_LAMDA),XP(GREEK_LC_THETA, GREEK_UC_THETA),XP(GREEK_LC_UPSILON, GREEK_UC_UPSILON),X(TWO_DOT_LEADER),X(BULLET),     FT,      FT,      FT,                            X(FTS_BOX_DS_RD),X(FTS_BOX_DS_HD),X(FTS_BOX_DS_LD),      FT,
        X(FTS_BOX_VD_RS),X(FTS_BOX_VD_HS),X(FTS_BOX_VD_LS),       FT,       FT,       FT,       FT,  XP(GREEK_LC_ALPHA, GREEK_UC_ALPHA), XP(GREEK_LC_RHO, GREEK_UC_RHO), XP(GREEK_LC_SIGMA, GREEK_UC_SIGMA), XP(GREEK_LC_TAU, GREEK_UC_TAU),XP(GREEK_LC_DELTA, GREEK_UC_DELTA), X(MATHEMATICAL_RIGHT_WHITE_SQUARE_BRACKET), XP(GREEK_LC_ETA, GREEK_UC_ETA), XP(GREEK_LC_NU, GREEK_UC_NU), XP(GREEK_LC_EPSILON, GREEK_UC_EPSILON), XP(GREEK_LC_IOTA, GREEK_UC_IOTA), XP(GREEK_LC_OMICRON, GREEK_UC_OMICRON),      FT,      FT,      FT,                                           X(FTS_BOX_VS_RD),X(FTS_BOX_VS_HD),X(FTS_BOX_VS_LD),FT,
        X(FTS_BOX_UD_RS),X(FTS_BOX_UD_HS),X(FTS_BOX_UD_LS),       FT,       FT,       FT,       FT,  FT,  XP(GREEK_LC_ZETA, GREEK_UC_ZETA), XP(GREEK_LC_CHI, GREEK_UC_CHI), XP(GREEK_LC_PSI, GREEK_UC_PSI), XP(GREEK_LC_OMEGA, GREEK_UC_OMEGA), XP(GREEK_LC_BETA, GREEK_UC_BETA), X(INTEGRAL), XP(GREEK_LC_KAPPA, GREEK_UC_KAPPA), XP(GREEK_LC_MU, GREEK_UC_MU), X(MUCH_LESS_THAN), X(MUCH_GREATER_THAN),      FT,      FT,      FT,      FT,                            X(FTS_BOX_US_RD),X(FTS_BOX_US_HD),X(FTS_BOX_US_LD),      FT,
    ...
    [_FN] = LAYOUT_h7v3_183(
        ...
        FT,               FT,                 FT,                 FT,                 FT,                 FT,                FT,                FT,                 FT,                FT,               FT,                 FT,                  FT,                FT,
        FT,      FT,      FT,       FT,       FT,                 FT,       FT,       FT,       FT,       FT,       FT,      FT,       FT,      FT,       FT,       FT,      FT,       FT,      FT,      FT,       FT,       FT,                  FT,      FT,       FT,      FT,
        FT,         FT,         FT,         FT,             FT,       FT,       FT,       KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_F6,    FT,       KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,  KC_F12,  FT,       FT,       FT,                  FT,      FT,       FT,      FT,
        FT,         FT,         FT,         FT,             FT,       FT,       FT,       FT,       FT,  FT,       FT,       FT,       FT,       FT,       FT,       FT,       FT,       FT,       FT,      FT,      FT,       FT,                            FT,      FT,       FT,      FT,
