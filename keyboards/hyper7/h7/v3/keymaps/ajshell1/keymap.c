...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_HEB] = LAYOUT_h7v3_213(
        ...
        FT,         FT,         FT,         FT,             FT,       FT,       FT,       FT,       FT,       FT,       FT,       FT,       FT,       FT,       FT,       FT,       FT,       FT,       FT,      FT,      FT,       FT,       FT,                  FT,      FT,       FT,      FT,
        FT,         FT,         FT,         FT,             FT,       FT,       FT,       X(HEB_QOF),X(HEB_VAV),X(HEB_FINAL_PE),X(HEB_PE),X(HEB_GIMEL),X(HEB_TSADI),X(HEB_FINAL_TSADI),X(HEB_LAMED),       FT,       FT,       FT,       FT,      FT,      FT,       FT,                            FT,      FT,       FT,      FT,
        FT,         FT,         FT,         FT,             FT,       FT,       FT,       X(HEB_ALEF),X(HEB_RESH),X(HEB_SAMEKH),X(HEB_TAV),X(HEB_DALET),FT,X(HEB_FINAL_NUN),X(HEB_NUN),X(HEB_HE),X(HEB_YOD),X(HEB_AYIN),       FT,      FT,      FT,                                      FT,      FT,       FT,      FT,
        FT,         FT,         FT,         FT,             FT,       FT,       FT,       FT,       X(HEB_ZAYIN),X(HEB_HET),           KC_C,  KC_V,       X(HEB_BET),       X(HEB_SHIN),      X(HEB_KAF),  X(HEB_MEM),X(HEB_FINAL_KAF),X(HEB_FINAL_MEM),       FT,      FT,      FT,       FT,                            FT,      FT,       FT,      FT,
        FT,         FT,         FT,         FT,             FT,       FT,       FT,       FT,       FT,       FT,       FT,       FT,       FT,       FT,       FT,       FT,       FT,       FT,       FT,      FT,      FT,                                      FT,      FT,       FT,      FT
    )
};    
